...
router.put("/admin/categories/:id", requireAdmin, async (req, res) => {
  try {
    ...
    const { name, icon, description, isActive, fields, groupId, nameI18n, descriptionI18n } = req.body;
    ...
    if (nameI18n && typeof nameI18n === "object") (updates as any).nameI18n = nameI18n;
    if (descriptionI18n && typeof descriptionI18n === "object") (updates as any).descriptionI18n = descriptionI18n;
